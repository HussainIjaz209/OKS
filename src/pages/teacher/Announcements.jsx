...
const TeacherAnnouncements = () => {
    ...
    // Mock Data
    const classes = ['All Classes', 'Class 9A', 'Class 9B', 'Class 10A']

    const [announcements, setAnnouncements] = useState([
        {
            id: 1,
            title: 'Math Olympiad Registration',
            message: 'Registration for the annual Math Olympiad is now open. Interested students should sign up by December 20th. The competition will be held on January 15th.',
        ...
        {
            id: 2,
            title: 'Class 9A Field Trip',
            message: 'Reminder: Signed permission slips for the Science Museum field trip are due tomorrow. Please ensure you bring them to the morning assembly.',
            audience: 'Class 9A',
            date: '2024-12-04',
            priority: 'medium',
            author: 'Mr. Smith'
        },
        {
            ...
            message: 'School will remain closed for Winter Break from Dec 24th to Jan 2nd. Classes will resume on Jan 3rd.',
            audience: 'All Classes',
            date: '2024-12-01',
            priority: 'low',
            author: 'Mr. Smith'
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 transform transition-all hover:scale-105">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-3xl font-bold text-gray-800">
                                {announcements.filter(a => a.date.startsWith('2024-12')).length}
                            </h3>
                        </div>
            ...
            <div className="space-y-6">
                {filteredAnnouncements.map((announcement) => (
                    <div key={announcement.id} className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex md:flex-col justify-center gap-3 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                                <button className="flex-1 md:flex-none bg-blue-50 hover:bg-blue-100 text-blue-600 p-3 rounded-xl transition-colors" title="Edit">
                                    <FontAwesomeIcon icon={faEdit} />
                                </button>
                                <button className="flex-1 md:flex-none bg-red-50 hover:bg-red-100 text-red-500 p-3 rounded-xl transition-colors" title="Delete">
