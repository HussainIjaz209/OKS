...
const Events = () => {
    ...
    const events = [
        ...
        },
        {
            ...
            description: 'Voice your opinions and compete with the best speakers.',
            color: 'purple'
        }
    ]
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
                ...
                <div className={`rounded-3xl bg-gradient-to-r ${featuredEvent.image} p-8 text-white shadow-2xl relative overflow-hidden group`}>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        ...
                        <div className="flex flex-col gap-3 w-full md:w-auto">
                            ...
                            <button className="bg-white/10 text-white border border-white/30 px-8 py-3 rounded-xl font-bold hover:bg-white/20 transition-all duration-300">
                                View Details
                            </button>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredEvents.map((event) => (
                    <div key={event.id} className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 hover:shadow-2xl transition-all duration-300 group flex flex-col">
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="text-center bg-gray-50 rounded-lg p-2 min-w-[60px]">
                                    <p className="text-xs text-gray-500 uppercase font-bold">{event.date.split(' ')[0]}</p>
                                    <p className="text-xl font-bold text-gray-800">{event.date.split(' ')[1].replace(',', '')}</p>
                                </div>
                            </div>
                            ...
                            <button className="w-full bg-gray-50 text-gray-700 font-bold py-3 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all duration-300 flex items-center justify-center group-hover:shadow-md">
                                View Details
